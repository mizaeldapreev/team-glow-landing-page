...
const Offer = () => {
  return (
    <section id="ebook" className="py-20 px-4 relative overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-landing-green/5 rounded-full blur-3xl animate-glow"></div>
    </section>
  );
};
